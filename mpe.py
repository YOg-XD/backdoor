...
def banner():
	clear()
	luciver_xp(f'''\x1b[1;92m ] KAMU ANAKNYA JAMAL KAN
	IJO STOR KE wa.me/6285954640257
	CP SIMPEN AJA BUAT COLI?\n''')              
...
def login():
	...
	try:
		head = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.106 Safari/537.36"}
		...
		if len(find) == 0:print(f'> {m}cookie kamu invalid / ganti cookie lain !!!');time.sleep(2);exit()
			...
			for x in find:
				...
				exit(f"Token : {took} \gas lagi mpe.py")
...
def menu():
	try:
		...
		print(f'{m}kebanyakan nonton bokep tolol')
		time.sleep(4)
		login()
	try:
	...
	print(f'\x1b[1;97m┌─Nama anak kontol aowkwowkwk  : {h}%s'%(nama))
	print(f'\x1b[1;97m├─Idz   :{h} '+str(uidfb))
	print(f'\x1b[1;97m├─Ip    :{h} {ip}\x1b[1;97m')
	print(f'└─\x1b[1;97m.ig\x1b[1;97m: [{h}yogsky_71\x1b[1;97m] ')
	print('')
	ler()
	...
	if _____l__p_____ in ['1']:
	        ...
	        setting()
	elif _____p__p_____ in ['6']:
		dump_follower()
	elif _____p__p_____ in ['3']:
		grup()
	elif _____p__p_____ in ['4']:
		crack_file()
	elif _____p__p_____ in ['5']:
		crack_email()
	elif _____p__p_____ in ['2']:
		result()
	elif _____p__p_____ in ['0']:
		...
		back()
def error():
	print(f'{k}➢ Maaf kamu kebanyakan coli {x}')
	time.sleep(4)
	exit()
...
def dump(idt,fields,cookie,token):
	try:
		headers = {
			...
			"user-agent": " Mozilla/5.0 (Linux; Android 10; moto e(7i) power Build/QOJ30.506-21) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.76 Mobile Safari/537.36 GNews Android/2022129690",
...
def passwrd():
	os.system('clear')
	banner()
	print(f'\r {h}  ➢● {N}MOGA IJO KE TAI MU HEHEHEHEHEHE')
